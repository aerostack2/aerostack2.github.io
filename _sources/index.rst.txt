...
.. raw:: html
    ...
    <div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; height: auto;">
        <iframe src="https://www.youtube.com/embed/IvItNtSB-QE" frameborder="0" allowfullscreen style="position: absolute; top: 0; left: 0; width: 80%; height: 80%;"></iframe>
    </div>
...
* **Jose María Cañas Plaza - Full Professor on Robotics at URJC:** We at JdeRobot organization (`<https://jderobot.github.io/>`_) extensively use Aerostack2 for our RoboticsAcademy project (`<https://github.com/JdeRobot/RoboticsAcademy>`_), in collaboration with Google Summer of Code program. In particular for the 6 drone based exercises. For instance Drone-Rescue-People (`<https://youtu.be/pwtvTTDCi2I>`_), Drone-Follow-Road (`<https://www.youtube.com/watch?v=MKA5FcO0Jy8>`_), etc. We recently replaced the former PX4 drone support in RoboticsAcademy for the Aerostack2 drone support, which has been proven to be very robust and efficient. It has been a pleasure to interact with Aerostack2 community, enjoying its support and fast reaction times when solving issues. In addition, I have also done some research with Aerostack2 and real drones, for instance the FollowPerson behavior in a real Tello drone (https://www.youtube.com/watch?v=EueRdmVSMoI) using DeepLearning and reactive control.
