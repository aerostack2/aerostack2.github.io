...
Also, it is in charge of generate the `ROS 2 Tf2 <https://docs.ros.org/en/foxy/Tutorials/Intermediate/Tf2/Tf2-Main.html>`__ tree, so the rest of the components can consult it.
